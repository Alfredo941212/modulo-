...
require '../configuracion/basedatos.php';
    ...
    ?>
<div class="modal fade" id="editaCliente" tabindex="-1" aria-labelledby="editaclienteModal" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editaclienteModal">Editar cliente</h5>
      ...
      <div class="modal-body">
        <form action="actualiza.php" method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <div class="invalid-feedback">Introduzca informacion válido</div>
          </div>
